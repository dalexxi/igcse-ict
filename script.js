                ...
                unit.lessons.forEach(lesson => {
                    if(lesson.contents && lesson.contents.length > 0) {
                        ...
                        lesson.contents.forEach(subLesson => {
                            html += '<div class="sublesson-label"><p>' + subLesson.subLessonTitle + '</p></div>';
                            html += '<div class="sublesson-accordion">';
                            // Add content for sub-lesson here
                            html += '</div>'; // Close sublesson-accordion
                        });
                        html += '</div>'; // Close lesson-accordion
                    } else {
                        html += '<p><a href="' + lesson.link + '">' + lesson.lessonTitle + '</a></p>';
                    }
                });
                html += '</div>'; // Close unit-accordion
            });
